...
parser.add_argument('-d', '--date', help='Datetime for search:\n less than: "../2022-01-13 00:00:00.000",\nmore than: "2022-01-13 00:00:00.000/..",\nfrom - to "2022-01-13 00:00:00.000/2022-01-14 00:00:00.000",\nexact: "2022-01-13 00:00:00.000"', required=False)
parser.add_argument('-t', '--text', help='A text to look for', required=False)
parser.add_argument('-n', '--unwanted', help='A text to filter out logs. Logs with this text will be excluded from the results. Can be a string or a list divided by commas (e.g. "out of memory, info")', required=False)
parser.add_argument('--full', help='Return full log entry instead of default symbols Qty', required=False, default=False)
